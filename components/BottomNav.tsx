...
// 極簡線條圖示，取代原本的emoji（改版規格：不要使用太多Emoji，要有科技感/交易終端質感）。
function IconHome({ active }: { active: boolean }) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={active ? "currentColor" : "currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const items = [
  ...
  { href: "/opportunities", label: "機會", Icon: IconTarget },
  { href: "/market", label: "市場", Icon: IconMarket },
